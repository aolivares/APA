...
%   (1) Time (ms).
%   (2) 'Li Vorfuﬂ,N':  Front left foot pressure sensor.
%   (3) 'Li R¸ckfuﬂ,N': Back left foot pressure sensor.
%   (4) 'Re Vorfuﬂ,N':  Front right foot pressure sensor.
%   (5) 'Re R¸ckfuﬂ,N': Back right foot pressure sensor.
