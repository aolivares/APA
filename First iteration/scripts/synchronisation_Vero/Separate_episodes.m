...
signal_GW_inv=-signalPral;

[peak_value, peak_location] = findpeaks(signal_GW_inv,'minpeakheight',19);
...
for i=1:numb_episodes
    ...
    signal2=interp1(peak_loc_GW:length(signal),...
        signal(peak_loc_GW:length(signal)),xi2,'spline');
