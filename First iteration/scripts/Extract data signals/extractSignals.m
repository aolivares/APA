...
% -------------------------------------------------------------------------
   ...
   % Set flags which control the visibility of the figures.
    ...
    load(fullfile('../../data/GaitWatch/Raw/',char(filename_GW)));
...
%  name_file = strcat( name_file,'_synchronised');
%  
%  % Save all synchronised signals.
%  save(['../../data/Synchronised/' name_file '.mat'], ...
%  'ML_COP');
