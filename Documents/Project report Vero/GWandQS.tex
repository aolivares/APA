...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/QSvsGW/speed_stride_time, width=18cm, height = 8cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/QSvsGW/speed_var_stride_time, width=18cm, height = 8cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/QSvsGW/speed_angle, width=18cm, height = 9cm}
