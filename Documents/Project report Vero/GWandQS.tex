...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/QSvsGW/mean_stride_time, width=18cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/QSvsGW/var_stride_time, width=18cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/QSvsGW/mean_angle, width=18cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/QSvsGW/speed_stride_time, width=18cm}
	\caption{Mean of stride time difference for each speeds.}
	\label{fig:speed_stride_time}
\end{figure}

If we scan \ref{fig:speed_var_stride_time}, we can appreciate the differences between the variance of ‘stride time’. Also, the mean of the values for each speed are put in \ref{tab:speeds} and the variance increases as the speed does it as well.

\begin{figure}[H]
	\centering
	\epsfig{file=figures/QSvsGW/speed_var_stride_time, width=18cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/QSvsGW/speed_angle, width=18cm}
