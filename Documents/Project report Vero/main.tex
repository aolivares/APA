...
\begin{document}
	...
	\include{portada}		% Inclu�mos la portada en espa�ol
	\clearemptydoublepage
	
	\include{statement}      % Incluimos la declaración del proyecto
	\clearemptydoublepage
	\include{acknowledgements}      % Incluimos agradecimientos
	\clearemptydoublepage
	\include{abstract}      % Incluimos resumen
	\clearemptydoublepage
	\include{abbrevations}      % Incluimos abreviaciones
	\clearemptydoublepage
