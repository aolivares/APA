...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/ML_AccY_right, width=18cm, height=10cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/ML_AccY_left, width=18cm, height=10cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/trajectoryCOP, width=18cm, height=10cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/trajectoryAcc, width=18cm, height=10cm}
