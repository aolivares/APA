...
\begin{itemize}
	...
	\begin{figure}[H]
		\centering
		\epsfig{file=figures/Synchronisation/midlineForceplate, width=20cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/axesFP.pdf, width=10cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/axesGW.pdf, width=10cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/axesGWGyro.pdf, width=10cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/AP_AccX, width=18cm, height=10cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/ML_AccY_right, width=18cm, height=12cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/ML_AccY_left, width=18cm, height=12cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/trajectoryCOP, width=16cm, height=9.5cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/trajectoryAcc, width=16cm, height=9.5cm}
...
\begin{figure}[H]
	\centering
	\epsfig{file=figures/APA_analysis/GyroTrunk, width=18cm, height=10cm}
