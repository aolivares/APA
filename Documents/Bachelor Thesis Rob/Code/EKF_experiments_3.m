...
text(1.4, 50, ['\scriptsize $\frac{\operatorname', ...
...
text(6,-30, ['\scriptsize $\operatorname{RMSE}', ...
             '_{Acc} = ', num2str(RMSE_acc(1), ...
             '%0.2f$')], 'interpreter','latex');
text(6,-40, ['\scriptsize $\operatorname{RMSE}', ...
             '_{Acc-corrected} = ', ...
             num2str(RMSE_acc(2), ...
             '%0.2f$')], 'interpreter','latex');
text(6,-50, ['\scriptsize $\frac{\operatorname', ...
