...
\end{tikzpicture}
\caption{Conditional density of position based on data $z_1$ and $z_2$, adopted from \cite{Maybeck79}.} \label{fig:measurement_z2}
\end{figure}
