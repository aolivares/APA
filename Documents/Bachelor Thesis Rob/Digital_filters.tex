...
\begin{equation}\label{eq:process_noise}
  \mathbf{w}_{k} \sim N(0,\mathbf{Q})\,,
\end{equation}

\begin{equation}\label{eq:measurement_noise}
  \mathbf{v}_{k} \sim N(0,\mathbf{R})\,,
\end{equation}
...
\noindent
The term $[\mathbf{z}_k-\mathbf{H}_{k}\hat{\mathbf{x}}^-_k]$ is called the innovation and $\mathbf{K}_{k}$ the Kalman gain, given by
