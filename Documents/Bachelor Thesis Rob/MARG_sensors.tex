...
\draw[thick,->] (0,0,0) -- (.7,0,0) node[anchor=north west]{$x_0$};
\draw[thick,->] (0,0,0) -- (0,.7,0) node[anchor=north west]{$y_0$};
\draw[thick,->] (0,0,0) -- (0,0,.7) node[anchor=north west]{$z_0$};
...
\draw[thick,red,tdplot_rotated_coords,->] (0,0,0) -- (.7,0,0) node[anchor=north east]{$x_1$};
...
\draw[thick,tdplot_rotated_coords,red,->] (0,0,0) -- (0,.7,0) node[anchor=north west]{$y_2$};
\draw[thick,tdplot_rotated_coords,red,->] (0,0,0) -- (0,0,.7) node[anchor=south]{$z_2$};
...
\draw[thick,tdplot_rotated_coords,blue,->] (0,0,0) -- (0,.67,0) node[anchor=west]{$y_3$};
\draw[thick,tdplot_rotated_coords,blue,->] (0,0,0) -- (0,0,0.93) node[anchor=north east]{$z_3$};
