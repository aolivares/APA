...
Magnetometers measure the strength and the direction of the magnetic field at a point in space. There are numerous techniques used to produce magnetic field sensors, which exploit a broad range of physical phenomena \cite{lenz_magnetic_2006}. Many magnetic sensors use the relationship between magnetic fields, movement and induced currents \cite{olivares_vicente_signal_2013}. \citeauthor{lenz_magnetic_2006} deliver a complete survey of common technologies used for magnetic field sensing in \cite{lenz_magnetic_2006}. Most \gls{MEMS} magnetometers sense mechanical motion of the MEMS structure due to the Lorentz force on a current-carrying conductor in the magnetic field.

In body motion analysis magnetometers are mainly used for calibration of accelerometers and gyroscopes.
