...
\end{tikzpicture}
\caption{A mass-and-spring accelerometer under different conditions: (a) at rest or in uniform motion, (b) accelerating, and (c) at rest, being exposed to gravity, from \cite{bhattacharyya_inertial_sensors_applications_13}.}
