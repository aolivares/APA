...
\newglossaryentry{not:sigma}{
  type=notation,  name={$\sigma$},  description={Standard deviation of conditional probability density},  sort={sigma}}
...
\newglossaryentry{not:K}{
 ...
 \newglossaryentry{not:k}{
  type=notation,  name={$k$},  description={Discrete time normalised to sampling time ($t/T_s$), or sample number, $k \in \mathbb{N}^0$},  sort={k}}
  
\newglossaryentry{not:T_s}{
  type=notation,  name={$T_s$},  description={Sampling time $T_s=1/f_s$},  sort={Ts}} 

\newglossaryentry{not:f_s}{  
